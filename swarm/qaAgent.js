...
export class QAAgent extends BaseAgent {
  ...
  async execute(task) {
    ...
    runTest('buildWhatsAppUrl estructura el reporte con nombre, edad, año de inicio, teléfono y situación del cliente', () => {
      ...
      if (decoded.includes('Correo:')) throw new Error('El mensaje no debe pedir correo');
